...
const BedIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 4v16"/><path d="M2 12h20"/><path d="M7 4v16"/><path d="M12 4v16"/><path d="M17 4v16"/><path d="M22 4v16"/><path d="M4 8h16"/><path d="M4 16h16"/></svg>
);
...
const CoffeeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="2" x2="6" y2="8"/><line x1="10" y1="2" x2="10" y2="8"/><line x1="14" y1="2" x2="14" y2="8"/></svg>
);
...
export const ICONS: { [key: string]: React.FC<React.SVGProps<SVGSVGElement>> } = {
  'Room Book': BedIcon,
  'Room Change': RefreshCwIcon,
  'Hostel Complain': MessageSquareIcon,
  'Feedback': StarIcon,
  'Laundry': ShirtIcon,
  'Late Entry': ClockIcon,
...
type IconName = 'Room Book' | 'Room Change' | 'Hostel Complain' | 'Feedback' | 'Laundry' | 'Late Entry' | 'Personal Details' | 'Student Database' | 'user' | 'close' | 'building' | 'Breakfast' | 'Lunch' | 'Snacks' | 'Dinner';
